...
async function main() {
  ...
  const el5 = await driver.$("xpath://android.view.View[@content-desc=\"profile\"]/android.widget.Button");
  await el5.click();
  await driver.touchAction([
    { action: 'press', x: 468, y: 1726 },
    { action: 'moveTo', x: 481, y: 303 },
    'release'
  ]);
  const el6 = await driver.$("xpath://android.widget.Button[@text=\"Logout\"]");
  await el6.click();
