...
async function main() {
  ...
  const el5 = await driver.$("xpath://android.view.View[@content-desc=\"help\"]/android.widget.Button");
  el5.click();
  await new Promise((resolve) => setTimeout(resolve, 2000));

  const el6 = await driver.$("xpath://android.view.View[@content-desc=\"documents\"]/android.widget.Button");
  el6.click();
  await new Promise((resolve) => setTimeout(resolve, 2000));

  const el7 = await driver.$("xpath://android.view.View[@content-desc=\"profile\"]/android.widget.Button");
  el7.click();
  await new Promise((resolve) => setTimeout(resolve, 2000));

  const el8 = await driver.$("xpath://android.view.View[@content-desc=\"home\"]/android.widget.Button");
  el8.click();
